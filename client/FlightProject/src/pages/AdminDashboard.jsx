...
//     await commonApi(`http://127.0.0.1:8000/api/admin/users/${id}/approve/`, "POST", null, token);
//     fetchPending();
//   }
...
//     e.preventDefault();
//     const data = await commonApi("http://127.0.0.1:8000/api/flights/", "POST", flightForm, token);
...
//             <li key={u.id}>
//               {u.username} ({u.email})
//               <button className="btn btn-success btn-sm ms-2" onClick={() => approveUser(u.id)}>Approve</button>
//             </li>
//           ))}
//         </ul>
//       }
...
//       <button className="btn btn-primary mb-2" onClick={() => setShowFlightForm(!showFlightForm)}>
...
//       type="file"
//       accept="image/*"
//       onChange={(e) => setFlightForm({ ...flightForm, image: e.target.files[0] })}
//       className="mt-2"
//     />
//           <button type="submit" className="btn btn-success mt-2">Add Flight</button>
//         </form>
//       )}
//     </div>
//   );
...
//   // Add flight with FormData (for image upload)
//   const addFlight = async (e) => {
//     e.preventDefault();
...
//       formData,
//       token,
//       true // indicate that this is multipart/form-data
//     );
...
//             required
//             onChange={e =>
//               setFlightForm({ ...flightForm, seats_available: e.target.value })
//             }
//           />
